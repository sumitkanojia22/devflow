...
function HeroSection() {
  return (
    <div className="w-full grid grid-cols-7 md:grid-cols-8 xl:grid-cols-12 gap-x-2 pt-16 pb-8">
      ...
      {/* Image BG */}
      <div className=" xl:col-start-3 xl:col-end-11 md:col-start-2 md:col-end-8 col-start-2 col-end-7 xl:h-120 md:h-100 h-70 border-[0.2px] border-zinc-200   bg-[url(/images/herosecbelow.png)] xl:bg-cover md:bg-contain bg-contain bg-top bg-no-repeat rounded-md"></div>
    </div>
  );
}
